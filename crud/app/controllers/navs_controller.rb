class NavsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @nav.save
        format.html { redirect_to nav_url(@nav), notice: "Nav creado correctamente." }
  ...
  def update
    respond_to do |format|
      if @nav.update(nav_params)
        format.html { redirect_to nav_url(@nav), notice: "Nav actualizado correctamente." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to navs_url, notice: "Nav eliminado correctamente." }
